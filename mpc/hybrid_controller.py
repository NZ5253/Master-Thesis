...
class HybridController:
    ...
    def get_control(self, state: VehicleState, goal: ParkingGoal,
        ...
        # Mode 4: Goal reached
            ...
            return np.zeros(2)  # Zero control
    ...
    def _final_convergence(self, state: VehicleState, goal: ParkingGoal,
        ...
        # Use standard MPC for final approach
        # Temporarily increase goal weights for precise convergence
        original_w_xy = self.mpc.w_goal_xy
        original_w_theta = self.mpc.w_goal_theta

        self.mpc.w_goal_xy = 800.0      # Very strong for final convergence
        self.mpc.w_goal_theta = 240.0   # Very strong for final convergence
